...
> 4. Реализована механика Leash: отставшие или застрявшие дальше `leashDistance` (35м) враги автоматически переносятся за границу экрана ближе к герою, возвращаясь в бой (исключает зависание на 500x500 арене и исключает абуз бегства).
